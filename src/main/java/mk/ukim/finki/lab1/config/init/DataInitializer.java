...
//        bookRepository.save(new Book("Book 1", "test", category1, authorRepository.findById(1L).get(), 100));
//        bookRepository.save(new Book("Book 2", "1234", category2, authorRepository.findById(2L).get(), 500));
//
